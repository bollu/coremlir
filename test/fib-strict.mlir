      ...
      standalone.lambda [%i] {
        ...
        { //default
          ...
          ^entry(%ds: !core.return):
            ...
            //  %fib_i_minus_one = standalone.apSSA(%fib, %i_minus_one)
            ...
            standalone.case { standalone.return(%fib_i_minus_one) } { alt0="default"}
            { //default
              ...
              ^entry(%wild: !core.return):
                %fib_i = standalone.apSSA(%fib_proxy, %i)

                %add_wild_fn = standalone.caseSSA %fib_i {alt0="default"} 
                                      { //default
                                          ^entry(%wild_inner: none):
                                            // %plus_wild_inner = standalone.ap(%constructor_plus, %wild_inner)
                                            standalone.return(%wild_inner)
                                      }
                standalone.return(%add_wild_fn)
